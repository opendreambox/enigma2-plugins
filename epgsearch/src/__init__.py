...
config.plugins.epgsearch.blue_function = ConfigSelection(choices=[("combi",_("show combi search list")),("ask",_("Ask user")),("searchlist",_("open search filter list")),("history",_("show only history"))], default="combi")