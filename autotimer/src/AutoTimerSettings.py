	...
	def __init__(self, session):
		...
		ConfigListScreen.__init__(
			...
			[
				...
				getConfigListEntry(_("Show 'add to filterlist' in film menu"), config.plugins.autotimer.show_addto_in_filmmenu, _("Enable this to be able to add recordings to filterlist from within the film menu.")),
