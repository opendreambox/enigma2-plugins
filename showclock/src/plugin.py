...
class ShowClockSetup(Screen, ConfigListScreen): # config
	...
	skin = """
		<screen name="ShowClock" position="center,center" size="820,340" title="Show Clock Setup" >
			...
			<widget render="Label" source="key_red" position="10,5" size="200,40" zPosition="1" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" shadowColor="black" shadowOffset="-2,-2" />
			<widget render="Label" source="key_green" position="210,5" size="200,40" zPosition="1" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" shadowColor="black" shadowOffset="-2,-2" />
			<widget render="Label" source="key_yellow" position="410,5" size="200,40" zPosition="1" font="Regular;20" halign="center" valign="center" backgroundColor="#a08500" transparent="1" shadowColor="black" shadowOffset="-2,-2" />
			<widget render="Label" source="key_blue" position="610,5" size="200,40" zPosition="1" font="Regular;20" halign="center" valign="center" backgroundColor="#18188b" transparent="1" shadowColor="black" shadowOffset="-2,-2" />

			<widget name="config" position="10,60" size="800,180" enableWrapAround="1" scrollbarMode="showOnDemand" />

			<eLabel position="10,50" size="800,1" backgroundColor="grey" />
			<ePixmap pixmap="skin_default/div-h.png" position="10,260" size="800,2" />
			<widget source="help" render="Label" position="10,270" size="800,50" font="Regular;20" halign="center" valign="center" transparent="1" />
		</screen>"""
